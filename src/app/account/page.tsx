  ...
  return (
    <div className="min-h-screen pb-16" style={{ backgroundColor: bgColor, color: textColor }}>
      ...
      <main className="pt-16 max-w-2xl mx-auto px-4 py-6">
        {/* プロフィール情報 */}
        <div className="border rounded-2xl overflow-hidden mb-6" style={{ borderColor }}>
          <div className="p-6">
            <div className="flex items-center gap-4 mb-6">
              <div className="relative w-20 h-20 rounded-full overflow-hidden" style={{ backgroundColor: isDark ? '#262626' : '#efefef' }}>
                {profile?.avatar_url ? (
                  <Image src={profile.avatar_url} alt={displayName} fill className="object-cover" />
                ) : (
                  <div className="w-full h-full flex items-center justify-center">
                    <svg className="w-10 h-10" fill="none" stroke={mutedColor} viewBox="0 0 24 24">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-semibold mb-1">{displayName || '名前未設定'}</h2>
                <p className="text-sm" style={{ color: mutedColor }}>{profile?.role === 'admin' ? '管理者' : 'メンバー'}</p>
              </div>
            </div>
        ...
        <div className="border rounded-2xl overflow-hidden mb-6" style={{ borderColor }}>
          ...
          >
            ...
            <div className="px-3 py-1 rounded-full text-sm" style={{ backgroundColor: isDark ? '#262626' : '#efefef' }}>
              {isDark ? 'ON' : 'OFF'}
            </div>
          </button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-5 h-16">
            ...
            <Link href="/account" className="flex flex-col items-center justify-center gap-1">
              ...
              <span className="text-xs font-semibold" style={{ color: textColor }}>設定</span>
            </Link>
