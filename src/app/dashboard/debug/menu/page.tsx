    ...
    <div className="max-w-5xl mx-auto px-4 py-10 space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">テスト・API確認・フラグ管理の入口です。</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Link href="/dashboard/debug" className="rounded-xl border border-border bg-card hover:bg-muted transition p-4 shadow-sm">
          <p className="text-sm text-muted-foreground mb-1">デバッグツール</p>
          <h2 className="text-lg font-semibold">APIテストやヘルスチェック</h2>
        </Link>
