      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-6">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <h1 className="text-2xl font-bold" style={{ color: textColor }}>デバッグメニュー</h1>
            <p className="text-sm" style={{ color: mutedColor }}>テスト・API確認・フラグ管理の入口です。</p>
          </div>
          <Link 
            href="/" 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            <p className="text-sm mb-1" style={{ color: mutedColor }}>デバッグツール</p>
            <h2 className="text-lg font-semibold" style={{ color: textColor }}>APIテストやヘルスチェック</h2>
          </Link>
          ...
          <div className="rounded-xl border border-dashed p-4" style={{ borderColor, color: mutedColor, opacity: 0.6 }}>
            <p className="text-sm mb-1">追加予定</p>
            <p className="text-base">ロードマップ</p>
          </div>
        </div>
      </div>
    </div>
