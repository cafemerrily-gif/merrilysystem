...
const defaultPresets: Preset[] = [
  {
    ...
    sections: {
      light: {
        header: { bg: '#1e3a8a', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e0e7ff', border: '#3b82f6', title: '#ffffff', subtitle: '#bfdbfe', user: '#dbeafe' },
        welcome: { bg: '#eff6ff', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#1e3a8a', border: '#93c5fd', title: '#1e3a8a', body: '#3b82f6' },
        card: { bg: '#ffffff', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#1e293b', border: '#cbd5e1' },
        content: { textColor: '#1e293b' },
        input: { bgColor: '#f8fafc', textColor: '#1e293b' },
      },
      dark: {
        header: { bg: '#0f172a', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e0e7ff', border: '#1e3a8a', title: '#ffffff', subtitle: '#93c5fd', user: '#bfdbfe' },
        welcome: { bg: '#1e3a8a', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e0e7ff', border: '#3b82f6', title: '#ffffff', body: '#bfdbfe' },
        card: { bg: '#1e293b', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e2e8f0', border: '#334155' },
        content: { textColor: '#e2e8f0' },
        input: { bgColor: '#334155', textColor: '#e2e8f0' },
      },
    },
  },
  {
    name: 'Emerald Garden (default)',
    sections: {
      light: {
        header: { bg: '#065f46', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#d1fae5', border: '#10b981', title: '#ffffff', subtitle: '#a7f3d0', user: '#d1fae5' },
      ...
      dark: {
        header: { bg: '#022c22', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#d1fae5', border: '#065f46', title: '#ffffff', subtitle: '#6ee7b7', user: '#a7f3d0' },
        welcome: { bg: '#065f46', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#d1fae5', border: '#10b981', title: '#ffffff', body: '#a7f3d0' },
        card: { bg: '#1e293b', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e2e8f0', border: '#334155' },
        content: { textColor: '#e2e8f0' },
        input: { bgColor: '#334155', textColor: '#e2e8f0' },
      },
  ...
  },
  {
    ...
    sections: {
      light: {
        header: { bg: '#c2410c', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fed7aa', border: '#f97316', title: '#ffffff', subtitle: '#fdba74', user: '#fed7aa' },
      ...
      dark: {
        header: { bg: '#7c2d12', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fed7aa', border: '#c2410c', title: '#ffffff', subtitle: '#fb923c', user: '#fdba74' },
        welcome: { bg: '#c2410c', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fed7aa', border: '#f97316', title: '#ffffff', body: '#fdba74' },
        card: { bg: '#1e293b', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e2e8f0', border: '#334155' },
        content: { textColor: '#e2e8f0' },
        input: { bgColor: '#334155', textColor: '#e2e8f0' },
      },
  ...
  },
  {
    ...
    sections: {
      light: {
        header: { bg: '#6b21a8', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e9d5ff', border: '#a855f7', title: '#ffffff', subtitle: '#d8b4fe', user: '#e9d5ff' },
      ...
      dark: {
        header: { bg: '#3b0764', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e9d5ff', border: '#6b21a8', title: '#ffffff', subtitle: '#c084fc', user: '#d8b4fe' },
        welcome: { bg: '#6b21a8', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e9d5ff', border: '#a855f7', title: '#ffffff', body: '#d8b4fe' },
        card: { bg: '#1e293b', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e2e8f0', border: '#334155' },
        content: { textColor: '#e2e8f0' },
        input: { bgColor: '#334155', textColor: '#e2e8f0' },
      },
  ...
  },
  {
    ...
    sections: {
      light: {
        header: { bg: '#9f1239', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fecdd3', border: '#f43f5e', title: '#ffffff', subtitle: '#fda4af', user: '#fecdd3' },
      ...
      dark: {
        header: { bg: '#4c0519', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fecdd3', border: '#9f1239', title: '#ffffff', subtitle: '#fb7185', user: '#fda4af' },
        welcome: { bg: '#9f1239', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fecdd3', border: '#f43f5e', title: '#ffffff', body: '#fda4af' },
        card: { bg: '#1e293b', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e2e8f0', border: '#334155' },
        content: { textColor: '#e2e8f0' },
        input: { bgColor: '#334155', textColor: '#e2e8f0' },
      },
  ...
  {
    name: 'Ocean Teal (default)',
    sections: {
      light: {
        header: { bg: '#115e59', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#ccfbf1', border: '#14b8a6', title: '#ffffff', subtitle: '#99f6e4', user: '#ccfbf1' },
      ...
      dark: {
        header: { bg: '#042f2e', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#ccfbf1', border: '#115e59', title: '#ffffff', subtitle: '#5eead4', user: '#99f6e4' },
        welcome: { bg: '#115e59', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#ccfbf1', border: '#14b8a6', title: '#ffffff', body: '#99f6e4' },
        card: { bg: '#1e293b', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e2e8f0', border: '#334155' },
        content: { textColor: '#e2e8f0' },
        input: { bgColor: '#334155', textColor: '#e2e8f0' },
      },
  ...
  {
    name: 'Charcoal Gray (default)',
    sections: {
      light: {
        header: { bg: '#374151', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#f3f4f6', border: '#6b7280', title: '#ffffff', subtitle: '#d1d5db', user: '#e5e7eb' },
        welcome: { bg: '#f9fafb', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#374151', border: '#9ca3af', title: '#374151', body: '#4b5563' },
        card: { bg: '#ffffff', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#1e293b', border: '#cbd5e1' },
        content: { textColor: '#1e293b' },
        input: { bgColor: '#f8fafc', textColor: '#1e293b' },
      },
      dark: {
        header: { bg: '#1f2937', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#f3f4f6', border: '#374151', title: '#ffffff', subtitle: '#9ca3af', user: '#d1d5db' },
        welcome: { bg: '#374151', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#f3f4f6', border: '#6b7280', title: '#ffffff', body: '#d1d5db' },
        card: { bg: '#1e293b', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e2e8f0', border: '#334155' },
        content: { textColor: '#e2e8f0' },
        input: { bgColor: '#334155', textColor: '#e2e8f0' },
      },
  ...
  {
    name: 'Amber Warmth (default)',
    sections: {
      light: {
        header: { bg: '#b45309', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fef3c7', border: '#f59e0b', title: '#ffffff', subtitle: '#fde68a', user: '#fef3c7' },
      ...
      dark: {
        header: { bg: '#78350f', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fef3c7', border: '#b45309', title: '#ffffff', subtitle: '#fbbf24', user: '#fde68a' },
        welcome: { bg: '#b45309', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#fef3c7', border: '#f59e0b', title: '#ffffff', body: '#fde68a' },
        card: { bg: '#1e293b', bgAlpha: 1, gradient: '', gradientType: 'none', fg: '#e2e8f0', border: '#334155' },
        content: { textColor: '#e2e8f0' },
        input: { bgColor: '#334155', textColor: '#e2e8f0' },
      },
