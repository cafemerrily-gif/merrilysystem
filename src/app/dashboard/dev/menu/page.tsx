      ...
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-6">
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <h1 className="text-2xl font-bold" style={{ color: textColor }}>開発部メニュー</h1>
            <p className="text-sm" style={{ color: mutedColor }}>メニュー管理など開発関連の入り口です。</p>
          </div>
          <Link 
            href="/" 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            <p className="text-sm mb-1" style={{ color: mutedColor }}>メニュー管理</p>
            <h2 className="text-lg font-semibold" style={{ color: textColor }}>カテゴリ・フォルダ・商品を管理</h2>
          </Link>
