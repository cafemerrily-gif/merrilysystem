...
export default function DevMenu() {
  ...
  const menuItems = [
    ...
    {
      title: '新商品企画',
      description: 'アイデア募集・投票・企画管理',
      href: '/dashboard/dev/product-ideas',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    {
      title: '試作記録',
      description: '試作履歴・評価・改善点',
      href: '/dashboard/dev/prototypes',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    {
      title: '顧客フィードバック',
      description: 'お客様の声・評価・要望',
      href: '/dashboard/dev/feedback',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
    ...
    {
      title: '季節商品カレンダー',
      description: '季節限定商品・イベント企画',
      href: '/dashboard/dev/seasonal',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  return (
    <div className="min-h-screen pb-16 md:pb-0" style={{ backgroundColor: bgColor, color: textColor }}>
      {/* PC版ナビゲーション */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-4 h-16">
            ...
            <Link href="/dashboard/dev/menu" className="flex flex-col items-center justify-center gap-1">
              ...
              <span className="text-xs font-semibold" style={{ color: textColor }}>開発部</span>
            </Link>
      ...
      <main className="pt-20 md:pt-32 max-w-2xl mx-auto px-4 py-6">
